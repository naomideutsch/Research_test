...
from solver_mloss import Solver
from rnn_mloss import GateRNNNet
...
parser.add_argument('--eval_every', default=1, type=int,
                    help='Evaluate every X epoches')
#DPRNN
parser.add_argument('--lr_decay', default=0.98, type=float,
                    help='Learning rate decay')
parser.add_argument('--rnn_hidden_dim', default=128, type=int,
                    help='Neurons in RNN')
parser.add_argument('--rnn_b_layer', default=6, type=int,
                    help='Blocks in RNN')
parser.add_argument('--lw', default=1.0, type=float,
                    help='loss weights')
parser.add_argument('--ide', default=1, type=int,
                    help='gpu for eval')
parser.add_argument('--tflip', default=0, type=int,
                    help='tflip')
parser.add_argument('--loss_every', default=2, type=float,
                    help='')
...
def main(args):
    ...
    # model
    model = GateRNNNet(args.N, args.L, args.B, args.H, args.P, args.X, args.R,
                       args.C, args.sample_rate, args.segment, args.rnn_b_layer, norm_type=args.norm_type, causal=args.causal,
